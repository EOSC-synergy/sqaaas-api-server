...
expected_repo_name = [
    ('https://github.com:443/eoscsynergy/sqaaas-api-server', False, 'eoscsynergy/sqaaas-api-server'),
    ('https://github.com:443/eoscsynergy/sqaaas-api-server', True, 'github.com:443/eoscsynergy/sqaaas-api-server'),
    ('https://github.com/eoscsynergy/sqaaas-api-server', False, 'eoscsynergy/sqaaas-api-server'),
    ('https://github.com/eoscsynergy/sqaaas-api-server', True, 'github.com/eoscsynergy/sqaaas-api-server'),
    ('http://github.com:443/eoscsynergy/sqaaas-api-server', False, 'eoscsynergy/sqaaas-api-server'),
    ('http://github.com:443/eoscsynergy/sqaaas-api-server', True, 'github.com:443/eoscsynergy/sqaaas-api-server'),
    ('http://github.com/eoscsynergy/sqaaas-api-server', False, 'eoscsynergy/sqaaas-api-server'),
    ('http://github.com/eoscsynergy/sqaaas-api-server', True, 'github.com/eoscsynergy/sqaaas-api-server'),
    ('github.com:443/eoscsynergy/sqaaas-api-server', False, 'eoscsynergy/sqaaas-api-server'),
    ('github.com:443/eoscsynergy/sqaaas-api-server', True, 'github.com:443/eoscsynergy/sqaaas-api-server'),
    ('github.com/eoscsynergy/sqaaas-api-server', False, 'eoscsynergy/sqaaas-api-server'),
    ('github.com/eoscsynergy/sqaaas-api-server', True, 'github.com/eoscsynergy/sqaaas-api-server')
]
